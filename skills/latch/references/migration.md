...
- Use `--authorization-file` for schema 3 authorization, `--retrospective-file` for retrospective input, and `--knowledge-impact-file` for submit and legacy patch input.
