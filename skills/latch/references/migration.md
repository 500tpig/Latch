...
- CLI `0.6.1` is the current runner; `0.5.0` remains the minimum writer for schema 5. New
...
- CLI `0.6.1` may read schema 2–5. It rejects every schema 2–4 task mutation with
